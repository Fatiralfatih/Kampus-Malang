<x-pengunjung-layout>
    ...
    <section class="pt-12">
        <div class="container">
            <div class="hero-content lg:flex-row-reverse flex-col max-w-full mx-auto">
                <div class="sm:max-w-full max-w-md">
                ...
                <div class="md:pt-3 lg:flex-row-reverse lg:ps-0 md:ps-4 sm:ps-6 w-full">
                    ...
                    <h1 class="text-[30px] lg:text-[35px] font-bold text-start">
                        {{ $kampus->nama }}
                    </h1>
                    <p class="lg:text-[20px] text-slate-600 dark:text-slate-200 capitalize">{{ $kampus->kategori }}</p>
    ...
    <section class="py-10">
        <div class="bg-base-200 dark:bg-gray-950 container">
            <div class="md:w-[800px] min-h-[200px] lg:text-center py-5 mx-auto text-center">
                <h2 class="md:text-2xl text-slate-800 dark:text-slate-200 font-sans text-xl font-semibold">
                    Profil Singkat {{ $kampus->nama }}
                </h2>
                <div class="mt-2">
                    <p
                        class="md:indent-5 lg:text-md text-start lg:text-center text-slate-800 dark:text-slate-200 max-w-full">
                        {{ $kampus->tentang }}
                    </p>
                </div>
            </div>
    ...
    <section class="pt-10">
        <div class="container">
            <div class="grid grid-cols-1 min-h-[350px] sm:grid-cols-3">
                ...
                <div class="lg:pt-0 sm:pt-0 inline-block">
                    ...
                    <div class="collapse collapse-arrow">
                        ...
                        <div class="collapse-content">
                            <ol class="ms-3 text-slate-800 dark:text-slate-200 items-center text-sm">
                                <li>1. S1 Bimbingan dan Konseling</li>
                                <li>2. S1 Teknologi Pendidikan</li>
                                <li>3. S1 Administrasi Pendidikan</li>
                                <li>4. S1 Pendidikan Luar Sekolah</li>
                            </ol>
                        </div>
                    </div>
                    <div class="collapse collapse-arrow">
                        ...
                        <div class="collapse-content">
                            <ol class="ms-3 text-slate-800 dark:text-slate-200 items-center text-sm">
                                <li>1. S1 Pendidikan Bahasa, Sastra Indonesia, & Daerah</li>
                                <li>2. S1 Bahasa dan Sastra Indonesia</li>
                                <li>3. S1 Ilmu Perpustakaan</li>
                                <li>4. S1 Pendidikan Bahasa Inggris</li>
                                <li>5. S1 Bahasa dan Sastra Inggris</li>
                            </ol>
                        </div>
                    </div>
                    <div class="collapse collapse-arrow">
                        ...
                        <div class="collapse-content">
                            <ol class="ms-3 text-slate-800 dark:text-slate-100 items-center text-sm">
                                <li>1. S1 Pendidikan Teknik Mesin</li>
                                <li>2. S1 Pendidikan Teknik Otomotif</li>
                                <li>3. S1 Teknik Mesin</li>
                                <li>4. S1 Pendidikan Teknik Informatika</li>
                                <li>5. S1 Teknik Informatika</li>
                            </ol>
                        </div>
                    </div>
                </div>
