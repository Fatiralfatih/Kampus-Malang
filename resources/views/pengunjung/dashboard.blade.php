<x-pengunjung-layout>
    ...
    <section class="pt-11 dark:text-white">
        <div class="container bg-base-200 rounded-lg min-h-[500px] md:min-h-[800px] lg:min-h-[600px] dark:bg-dark">
            <div class="pt-5">
            ...
            <div class="md:grid-cols-3 lg:grid-cols-4  grid grid-cols-1 gap-3 px-4 mx-auto my-1 mt-4 ">
                @forelse ($kampusFavorit as $kampus)
                    <div class="ps-6 pe-6 bg-ungu dark:bg-zinc-900  dark:text-white w-full pt-6 pb-6 rounded-lg shadow-xl ">
                        <div
            ...
            <div class="md:grid-cols-2 lg:grid-cols-2 grid grid-cols-1 gap-5 p-2 md:gap-4">
                @forelse ($kampuses as $kampus)
                    <div class="card card-compact lg:card-side bg-base-100 dark:bg-zinc-900 shadow-xl">
                        @forelse ($kampus->Gambar as $gambar)
                            <figure
                                class="h-15 aspect-[3/2] rounded-lg md:aspect-[6/4] md:flex overflow-hidden lg:aspect-video lg:min-w-[250px]">
                                <img class="rounded-lg w-full h-full" src="{{ asset('storage/' . $gambar->gambar) }}"
                                    alt="Kampus" />
                            </figure>
                        @empty
