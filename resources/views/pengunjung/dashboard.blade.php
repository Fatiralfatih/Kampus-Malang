                ...
                <div class="card-header d-flex flex-wrap justify-content-between gap-3">
                    ...
                    <form action="{{ route('pengunjung.dashboard') }}">
                        <div class="d-flex justify-content-md-end align-items-center gap-3 flex-wrap">
                            <select id="pilih-jurusan" class="select2 form-select" name="jurusan" data-placeholder="Jurusan">
                                <option disabled selected>Cari Jurusan</option>
                                @foreach ($jurusans->unique('nama') as $jurusan)
                        ...
                        <div class="col-sm-6 col-lg-4 grid-flow-col auto-cols-max">
                            <div class="card p-2 h-100 shadow-none border">
                                <div class="rounded-2 text-center mb-3 sm:w-30 sm:h-30" style="height: 320px">
                                    ...
                                    @else
                                        <p class="flex justify-center items-center uppercase text-red-500">tidak ada gambar</p>
                                    @endif
