            ...
            <div class="col-xl">
                <div class="card mb-2">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Fakultas {{ ucwords($fakultas->nama) }} Kampus {{ $fakultas->Kampus->nama }} </h5>
                        <small class="text-body float-end">Merged input group</small>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.fakultas.update', ['fakultas' => $fakultas->slug]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="input-group input-group-merge mt-2 mb-2">
                                <span class="input-group-text @error('tentang') border-red-500 @enderror">
