                    ...
                    <div class="card-body">
                        <div class="nav-align-left">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.fakultas', $kampus->slug) }}" class="nav-link {{ Request::is('admin/fakultas/'. $kampus->slug) ? 'active' : '' }}">
                                        Edit Fakultas
                                    </a>
                                </li>
                                <li class="nav-item">
                                        ...
                                        <div class="card">
                                            <div class="flex justify-between mb-2">
                                                ...
                                                <div class="card-header col-sm text-end">
                                                    <a href="{{ route('admin.fakultas.create', ['kampus' => $kampus->slug]) }}"
                                                        class="bg-sky-500 px-2 py-2 rounded-lg uppercase text-white hover:bg-sky-700">Tambah
                                                        Fakultas</a>
                                                    <a href="{{ route('admin.fakultas.history', ['kampus' => $kampus->slug]) }}"
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item"
                                                                                href="{{ route('admin.fakultas.edit', ['fakultas' => $fakultas->slug]) }}"><i
